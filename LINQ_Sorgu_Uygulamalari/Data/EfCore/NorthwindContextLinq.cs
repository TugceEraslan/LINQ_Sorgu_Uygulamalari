...
{
    public partial class NorthwindContextLinq : DbContext
    {
        public NorthwindContextLinq()
        {
        }

        public NorthwindContextLinq(DbContextOptions<NorthwindContextLinq> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                optionsBuilder
                    ...
                    .UseMySql("server=localhost;port=3306;database=northwind;user=root;password=mysql1234", x => x.ServerVersion("8.0.26-mysql"));
            }
        }
